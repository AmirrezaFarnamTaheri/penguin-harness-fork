...
export const zh = {
  ...
  consensus: {
    title: "智能体协作",
    demoDescription:
      "使用本地示例数据体验提案、消息和交接。更改不会发送给 Agent，离开此页面后也不会保存。",
    liveDescription: "已连接的实时数据反映当前项目的情况。决策仍为本地演示。",
    navigation: "协作视图",
    decisions: "决策",
    messages: "消息",
    handoffs: "交接",
    quorum: {
      ...
      refuted: "已反驳",
      propose: "提出决策",
      empty: "此视图中没有决策。提出决策以收集同行反馈。",
      proposer: "提案者：",
      peers: "同行赞同：",
      required: "需要",
      evidence: "证据与异议",
      endorsements: "赞同",
      noEndorsements: "尚无同行赞同。",
      approved: "已批准",
      refutations: "反驳",
      refute: "反驳",
      endorse: "附证据赞同",
      ...
      summary: "决策主题摘要",
      newTopic: "新主题",
      topicPlaceholder: "例如：将 AST 索引重构到后台工作线程",
      proposerAgent: "提案 Agent",
      newProposer: "新提案者",
      threshold: "赞同阈值",
      newThreshold: "新阈值",
      endorseTitle: "赞同决策主题",
      ...
      confirmRefute: "确认反驳",
      topic: "主题：",
      actingAgent: "操作 Agent 角色",
      actionAgent: "操作 Agent",
      citation: "证据或引用",
      grounds: "操作依据",
      groundsPlaceholder: "引用证明此断言的基准测试、文件或测试……",
    },
    mailbox: {
      liveTitle: "消息（实时）",
      demoTitle: "消息（本地演示）",
      liveDescription: "来自项目运行中智能体群的队列和租约。",
      demoDescription: "示例队列和租约。在此创建的消息仅保留在本页面。",
      compose: "编写演示消息",
      composeTitle: "编写演示消息",
      held: "持有租约",
      expired: "已过期",
      ...
      eventLabel: "事件类型",
      event: "事件类型",
      eventPlaceholder: "例如：directive:refactor_code",
      payloadLabel: "JSON 载荷",
      payload: "载荷文本",
    },
    timeline: {
      liveTitle: "交接（实时）",
      demoTitle: "交接（本地演示）",
      liveDescription: "在此项目智能体群中观察到的任务启动和指令。",
      demoDescription: "查看示例任务从委派到评审的过程。这不反映运行中 Agent 的情况。",
      advancing: "正在推进……",
      simulate: "模拟下一阶段",
      empty: "此连接中尚未观察到任务启动或指令。",
      started: "任务已启动",
      dispatched: "已派发",
      task: "任务：",
      planned: "计划目标；此事件不报告任务分配是否送达。",
      completed: "已完成",
      in_progress: "进行中",
      blocked: "已阻塞",
      pending: "待处理",
  ...
  guardian: {
    audit: {
      ...
      eventHash: "事件哈希",
      owner: "所属智能体与会话",
      executingSession: "执行会话",
      unknownExecutor: "未知（旧版回执）",
      tool_call: "工具调用",
  ...
  nav: {
    ...
    newChat: "新对话",
    navigation: "导航",
    toolGroups: { build: "构建与知识", inspect: "评估与诊断", manage: "模型与访问" },
    cockpit: "工作区概览",
    spendFlow: "消耗流向",
    topology: "代码结构",
    guardian: "命令安全",
    consensus: "智能体共识",
    contextBreakdown: "上下文用量",
    memory: "记忆",
    keyFleet: "API 密钥",
    flamegraph: "轨迹性能",
    snapshots: "会话快照",
  ...
  models: {
    ...
    imageBaseUrlHint: "用于图像/视觉多模态调用的独立端点（例如 https://api-images.bynara.id/v1/）",
    ...
    tabCatalog: "模型列表",
    tabKeyPools: "Key 池与健康度",
    keyPoolsTitle: "API Key 状态与轮换监控",
    keyPoolsDesc: "实时监控多 Key 轮询轮换、429 速率限制冷却、401 失效状态及失败统计。",
    filterAll: "全部模型",
    filterHealthy: "仅健康",
    ...
    lastUsed: "最近调用",
    neverUsed: "未调用",
    noKeysConfigured: "使用环境变量回退或全局网关",
    allKeysHealthy: "全部 Key 状态健康",
