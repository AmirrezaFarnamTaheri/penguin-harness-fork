...
export const en: Strings = {
  ...
  consensus: {
    ...
    quorum: {
      ...
      empty: "No decisions in this view. Propose a decision to collect peer feedback.",
      proposer: "Proposer:",
      peers: "Peer endorsements:",
      required: "required",
      evidence: "Evidence and objections",
      endorsements: "Endorsements",
      noEndorsements: "No peer endorsements yet.",
      approved: "Approved",
      refutations: "Refutations",
      refute: "Refute",
      endorse: "Endorse with evidence",
      proposeTitle: "Propose a decision",
      cancel: "Cancel",
      create: "Create Proposal",
      summary: "Decision Topic Summary",
      newTopic: "New topic",
      topicPlaceholder: "e.g. Refactor AST indexing to background worker thread",
      proposerAgent: "Proposer Agent",
      newProposer: "New proposer",
      threshold: "Endorsements Threshold",
      newThreshold: "New threshold",
      endorseTitle: "Endorse Decision Topic",
      refuteTitle: "Refute Decision Topic",
      confirmEndorse: "Confirm Endorsement",
      confirmRefute: "Confirm Refutation",
      topic: "Topic:",
      actingAgent: "Acting Agent Role",
      actionAgent: "Action agent",
      citation: "Evidence or citation",
      grounds: "Action grounds",
      groundsPlaceholder: "Cite the benchmark, file, or test proving this assertion...",
    },
    mailbox: {
      liveTitle: "Messages (live)",
      demoTitle: "Messages (local demo)",
      liveDescription: "Queues and leases from the project's running swarm.",
      demoDescription: "Sample queues and leases. Messages created here stay in this page.",
      compose: "Compose demo message",
      composeTitle: "Compose demo message",
      held: "LEASE HELD",
      expired: "EXPIRED",
      idle: "IDLE",
      depth: "Queue Depth:",
      ...
      event: "Event type",
      eventPlaceholder: "e.g. directive:refactor_code",
      payloadLabel: "JSON Payload",
      payload: "Payload text",
    },
    timeline: {
      liveTitle: "Handoffs (live)",
      demoTitle: "Handoffs (local demo)",
      liveDescription: "Task starts and directives observed in this project's swarm.",
      demoDescription:
        "Follow a sample task from delegation to review. This does not reflect running agents.",
      advancing: "Advancing...",
      simulate: "Simulate Next Stage",
      empty: "No task starts or directives observed in this connection.",
      started: "Task started",
      dispatched: "Dispatched",
      task: "Task:",
      planned: "Planned target; assignment delivery is not reported by this event.",
      completed: "completed",
  ...
  guardian: {
    audit: {
      ...
      owner: "Owner",
      executingSession: "Executing session",
      unknownExecutor: "Unknown (legacy receipt)",
      tool_call: "Tool call",
  ...
  nav: {
    ...
    toolGroups: {
      ...
      inspect: "Review & diagnostics",
      manage: "Models & access",
    },
    cockpit: "Workspace overview",
    spendFlow: "Spend flow",
    topology: "Code structure",
    guardian: "Shell safety",
    consensus: "Agent consensus",
    contextBreakdown: "Context usage",
    memory: "Memory",
    keyFleet: "API keys",
