...
// lib/l10n/app_zh.arb
{
  ...
  "lastUpdated": "last updated:{date}",
  "price": "price:{amount}",
  "gender": "{gender, select, male{he} female{she} other{Ta}}liked"
}
```
...
// lib/l10n/app_ja.arb
{
  ...
  "itemCount": "{count, plural, =0{アイテムなし} other{{count}items}}",
  "lastUpdated": "last updated:{date}",
  "price": ":{amount}",
  "gender": "{gender, select, male{he} female{she} other{そのpeople}}がいいねしました"
}
```
