...
- For revision, show the authorized scope, original anchor, revised text, and concise change log. A request to direct edit may compress these labels, but does not waive this minimum audit frame.
