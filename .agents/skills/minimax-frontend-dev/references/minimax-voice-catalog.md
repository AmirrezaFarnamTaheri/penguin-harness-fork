...
|----------|------|-------------|----------|----------|
| `clever_boy` | smart boy | Smart, witty boy voice | Children's content, educational | Chinese (Mandarin) |
| `cute_boy` | cute boy | Adorable young boy voice | Kids' content, animations | Chinese (Mandarin) |
| `lovely_girl` | cute little girl | Cute, sweet girl voice | Children's stories, games | Chinese (Mandarin) |
| `cartoon_pig` | cartoon pig Xiaoqi | Cartoon character voice | Animations, comedy, entertainment | Chinese (Mandarin) |
...
| voice_id | Name | Description | Best For | Language |
|----------|------|-------------|----------|----------|
| `male-qn-qingse` | green youth | Youthful, inexperienced young man voice | Campus stories, coming-of-age content | Chinese (Mandarin) |
| `male-qn-daxuesheng` | young university student | Young university student voice | Campus content, educational | Chinese (Mandarin) |
| `female-shaonv` | young girl | Young maiden voice | Romance, youth content | Chinese (Mandarin) |
| `bingjiao_didi` | yandere younger brother | Tsundere young brother voice | Romance, character-driven content | Chinese (Mandarin) |
| `junlang_nanyou` | handsome boyfriend | Handsome boyfriend voice | Romance, dating content | Chinese (Mandarin) |
| `chunzhen_xuedi` | innocent junior boy | Innocent junior student voice | Campus stories, youth content | Chinese (Mandarin) |
| `lengdan_xiongzhang` | aloof senior | Cool senior student voice | Campus stories, romance | Chinese (Mandarin) |
| `diadia_xuemei` | sweet junior girl | Flirty junior girl voice | Romance, dating content | Chinese (Mandarin) |
| `danya_xuejie` | elegant senior girl | Elegant senior girl voice | Campus stories, romance | Chinese (Mandarin) |
| `Chinese (Mandarin)_Straightforward_Boy` | frank younger brother | Frank, straightforward boy voice | Casual, direct content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Sincere_Adult` | sincere youth | Sincere young adult voice | Honest, genuine content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Pure-hearted_Boy` | clear boy-next-door | Pure-hearted neighbor boy voice | Innocent, wholesome content | Chinese (Mandarin) |
...
| voice_id | Name | Description | Best For | Language |
|----------|------|-------------|----------|----------|
| `female-chengshu` | mature woman | Mature woman voice | Sophisticated, adult content | Chinese (Mandarin) |
| `female-yujie` | mature woman | Mature, elegant woman voice | Romance, professional content | Chinese (Mandarin) |
| `female-tianmei` | sweet woman | Sweet, pleasant woman voice | Soft, gentle content | Chinese (Mandarin) |
| `badao_shaoye` | domineering young master | Arrogant young master voice | Drama, character roles | Chinese (Mandarin) |
| `wumei_yujie` | charming mature woman | Charming mature woman voice | Romance, mature content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Gentleman` | warm male voice | Gentle, refined male voice | Narration, storytelling | Chinese (Mandarin) |
| `Chinese (Mandarin)_Unrestrained_Young_Man` | rebellious youth | Unrestrained young man voice | Casual, entertainment content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Southern_Young_Man` | southern young man | Southern young man voice | Regional character, casual content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Gentle_Youth` | warm youth | Gentle young man voice | Narration, calm content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Warm_Girl` | warm young girl | Warm young girl voice | Friendly, supportive content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Soft_Girl` | soft young girl | Soft, gentle girl voice | Calm, soothing content | Chinese (Mandarin) |
...
| voice_id | Name | Description | Best For | Language |
|----------|------|-------------|----------|----------|
| `Chinese (Mandarin)_Humorous_Elder` | funny grandpa | Humorous old man voice | Comedy, entertainment | Chinese (Mandarin) |
| `Chinese (Mandarin)_Kind-hearted_Elder` | sixty-year-old grandma | Kind elderly lady voice | Stories, warm content | Chinese (Mandarin) |
| `Chinese (Mandarin)_Kind-hearted_Antie` | warm-hearted auntie | Kind-hearted auntie voice | Warm, friendly content | Chinese (Mandarin) |
...
|----------|------|-------------|----------|
| `male-qn-qingse` | green youth | Youthful, inexperienced young man voice | Campus stories, coming-of-age content |
| `male-qn-badao` | domineering youth | Arrogant, dominant young man voice | Drama, romance, character roles |
| `male-qn-daxuesheng` | young university student | Young university student voice | Campus content, educational |
| `female-shaonv` | young girl | Young maiden voice | Romance, youth content |
| `female-yujie` | mature woman | Mature, elegant woman voice | Romance, professional content |
| `female-chengshu` | mature woman | Mature woman voice | Sophisticated, adult content |
| `female-tianmei` | sweet woman | Sweet, pleasant woman voice | Soft, gentle content |
| `clever_boy` | smart boy | Smart, witty boy voice | Children's content, educational |
| `cute_boy` | cute boy | Adorable young boy voice | Kids' content, animations |
| `lovely_girl` | cute little girl | Cute, sweet girl voice | Children's stories, games |
| `cartoon_pig` | cartoon pig Xiaoqi | Cartoon character voice | Animations, comedy, entertainment |
| `bingjiao_didi` | yandere younger brother | Tsundere young brother voice | Romance, character-driven content |
| `junlang_nanyou` | handsome boyfriend | Handsome boyfriend voice | Romance, dating content |
| `chunzhen_xuedi` | innocent junior boy | Innocent junior student voice | Campus stories, youth content |
| `lengdan_xiongzhang` | aloof senior | Cool senior student voice | Campus stories, romance |
| `badao_shaoye` | domineering young master | Arrogant young master voice | Drama, character roles |
| `tianxin_xiaoling` | sweetheart Xiaoling | Sweet Xiao Ling voice | Character roles, animations |
| `qiaopi_mengmei` | playful cute girl | Playful cute girl voice | Comedy, light-hearted content |
| `wumei_yujie` | charming mature woman | Charming mature woman voice | Romance, mature content |
| `diadia_xuemei` | sweet junior girl | Flirty junior girl voice | Romance, dating content |
| `danya_xuejie` | elegant senior girl | Elegant senior girl voice | Campus stories, romance |
| `Arrogant_Miss` | arrogant young lady | Arrogant young lady voice | Drama, character roles |
| `Robot_Armor` | mecha armor | Robotic armor voice | Sci-fi, game characters |
| `Chinese (Mandarin)_Reliable_Executive` | steady executive | Reliable executive voice | Corporate, business content |
| `Chinese (Mandarin)_News_Anchor` | news female voice | News anchor female voice | News broadcasts, current affairs |
| `Chinese (Mandarin)_Mature_Woman` | tsundere mature woman | Tsundere mature woman voice | Romance, character-driven content |
| `Chinese (Mandarin)_Unrestrained_Young_Man` | rebellious youth | Unrestrained young man voice | Casual, entertainment content |
| `male-qn-jingying` | elite youth | Elite, ambitious young man voice | Business, professional content |
| `Chinese (Mandarin)_Kind-hearted_Antie` | warm-hearted auntie | Kind-hearted auntie voice | Warm, friendly content |
| `Chinese (Mandarin)_HK_Flight_Attendant` | Hong Kong-accented flight attendant | HK accent flight attendant voice | Regional character, entertainment |
| `Chinese (Mandarin)_Humorous_Elder` | funny grandpa | Humorous old man voice | Comedy, entertainment |
| `Chinese (Mandarin)_Gentleman` | warm male voice | Gentle, refined male voice | Narration, storytelling |
| `Chinese (Mandarin)_Warm_Bestie` | warm best friend | Warm bestie female voice | Friendly, supportive content |
| `Chinese (Mandarin)_Male_Announcer` | broadcast male voice | Male announcer voice | Announcements, broadcasts |
| `Chinese (Mandarin)_Sweet_Lady` | sweet female voice | Sweet lady voice | Soft, gentle content |
| `Chinese (Mandarin)_Southern_Young_Man` | southern young man | Southern young man voice | Regional character, casual content |
| `Chinese (Mandarin)_Wise_Women` | experienced older sister | Experienced wise woman voice | Advice, guidance content |
| `Chinese (Mandarin)_Gentle_Youth` | warm youth | Gentle young man voice | Narration, calm content |
| `Chinese (Mandarin)_Warm_Girl` | warm young girl | Warm young girl voice | Friendly, supportive content |
| `Chinese (Mandarin)_Kind-hearted_Elder` | sixty-year-old grandma | Kind elderly lady voice | Stories, warm content |
| `Chinese (Mandarin)_Cute_Spirit` | silly cute beast | Cute cartoon spirit voice | Animations, children's content |
| `Chinese (Mandarin)_Radio_Host` | radio male host | Radio host male voice | Podcasts, radio shows |
| `Chinese (Mandarin)_Lyrical_Voice` | lyrical male voice | Lyrical male singing voice | Music, singing content |
| `Chinese (Mandarin)_Straightforward_Boy` | frank younger brother | Frank, straightforward boy voice | Casual, direct content |
| `Chinese (Mandarin)_Sincere_Adult` | sincere youth | Sincere young adult voice | Honest, genuine content |
| `Chinese (Mandarin)_Gentle_Senior` | gentle senior girl | Gentle senior girl voice | Campus stories, supportive content |
| `Chinese (Mandarin)_Stubborn_Friend` | stubborn childhood friend | Stubborn childhood friend voice | Drama, character-driven content |
| `Chinese (Mandarin)_Crisp_Girl` | crisp young girl | Crisp, clear young girl voice | Clear, bright content |
| `Chinese (Mandarin)_Pure-hearted_Boy` | clear boy-next-door | Pure-hearted neighbor boy voice | Innocent, wholesome content |
| `Chinese (Mandarin)_Soft_Girl` | soft young girl | Soft, gentle girl voice | Calm, soothing content |

### Chinese Cantonese Voices

| voice_id | Name | Description | Best For |
|----------|------|-------------|----------|
| `Cantonese_ProfessionalHost(F)` | professional female host | Professional female host voice | Cantonese broadcasts, hosting |
| `Cantonese_GentleLady` | gentle female voice | Gentle Cantonese female voice | Soft, warm Cantonese content |
| `Cantonese_ProfessionalHost(M)` | professional male host | Professional male host voice | Cantonese broadcasts, hosting |
| `Cantonese_PlayfulMan` | lively male voice | Playful Cantonese male voice | Entertainment, casual content |
| `Cantonese_CuteGirl` | cute girl | Cute Cantonese girl voice | Children's content, animations |
| `Cantonese_KindWoman` | kind female voice | Kind Cantonese female voice | Warm, friendly content |
