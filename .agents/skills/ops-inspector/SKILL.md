...
- The user asks for an "inspection", "health check", or "troubleshooting" of their CloudBase environment.
...
|------|-------------|-------|
| **Full inspection** | User asks for a general health check  | All resource types in the environment |
...
| Function OOM | `OOM OR out of memory` |
