...
Purpose: Read this when issuing a final verdict, assembling `## Attest Compliance Report`, calculating traceability coverage, or generating `ATTEST_TO_*_HANDOFF` payloads.
