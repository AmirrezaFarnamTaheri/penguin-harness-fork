...
**GOOD: Three-line table (three-line table) — top thick, header-bottom medium, table-bottom thick**
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ← 1.5pt top border
  Name    Dept    Score   Grade
...
**GOOD: Use bold or emphasis dots (emphasis mark) for Chinese emphasis**
```xml
...
<w:rPr>
  <w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"
            w:eastAsia="SimSun"/>
  <w:sz w:val="24"/>  <!-- small size 4 12pt -->
</w:rPr>
```
...
**GOOD: 1.5x line spacing or fixed 28pt for CJK body at 12pt (small size 4)**
```xml
<!-- Option A: 1.5x proportional -->
<w:spacing w:line="360" w:lineRule="auto"/>  <!-- 360/240 = 1.5x -->

<!-- Option B: Fixed 28pt (standard for small size 4/12pt CJK body) -->
<w:spacing w:line="560" w:lineRule="exact"/>  <!-- 28pt = 560 twips -->
```
For  (government documents) at size 3/16pt body:
```xml
