...
// --- Chinese document grid: 28 lines × 28 chars per line (common for ) ---
...
### 2.15 Three-Line Table (academic three-line table)

```csharp
// =============================================================================
// THREE-LINE TABLE (academic three-line table)
// =============================================================================
...
### 3.9 Chinese Government Document Page Numbers (official document page number)

```csharp
// =============================================================================
// CHINESE GOVERNMENT DOCUMENT PAGE NUMBERS (official document page number)
// =============================================================================
// Standard: bottom center, format "-X-" (em-dash surrounding page number)
// Font: SimSun (SimSun) size 4 (14pt = "28" half-points)
// Per GB/T 9704-2012
...
// Run properties for SimSun size 4
RunProperties GovPageRunProps() => new RunProperties(
    ...
    new FontSize { Val = "28" },           // 14pt = size 4
