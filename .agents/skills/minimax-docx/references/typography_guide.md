...
| **Chinese ** | size 3(16pt) | size 2(22pt) | size 3(16pt) | size 4(14pt) | small size 4(12pt) |
...
| 10.5pt (size 5) | 21 | CJK body small |
| 11pt | 22 | Standard body (Calibri) |
| 12pt (small size 4) | 24 | Standard body (TNR), CJK |
| 14pt (size 4) | 28 | CJK body, subheading |
| 16pt (size 3) | 32 | CJK heading, western H2 |
| 18pt (small size 2) | 36 | Western H1 |
| 22pt (size 2) | 44 | CJK document title |
| 26pt (size 1) | 52 | Large title |
...
| Fixed 28pt | `line="560"` lineRule="exact" | Chinese  (GB/T 9704) |
...
| **Chinese ** | 37mm | 35mm | 28mm | 26mm | T:2098 B:1984 L:1588 R:1474 |
...
| Chinese  | Bottom center, format "-X-" | Government documents |
...
|-------|------------|-------------|
| **Three-line (three-line table)** | Top rule + header-bottom rule + bottom rule only, no vertical lines | Academic, scientific — gold standard |
...
| red header agency name | Red #FF0000 |
| red rule separator | Red #FF0000 |
| official seal seal | Red |
...
**Chinese government ():**
```
1. (SimHei) → (1)(KaiTi) → 1.(FangSong bold) → (1)(FangSong)
```
...
### Chinese Government ( GB/T 9704)

| Parameter | Value | OpenXML |
|-----------|-------|---------|
| Body font | FangSong_GB2312 size 3 | sz="32", EastAsia="FangSong_GB2312" |
| Title | STSong small size 2 centered | sz="44" |
| L1 heading | SimHei size 3 | sz="32", EastAsia="SimHei" |
| L2 heading | KaiTi size 3 | sz="32", EastAsia="KaiTi_GB2312" |
...
| Page numbers | Bottom center, SimSun size 4, "-X-" | sz="28" |
| Chars/line | 28 | |
| Lines/page | 22 | |
