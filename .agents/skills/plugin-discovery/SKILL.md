...
description: This skill should be used when the user asks to "plugin recommendation", "find plugins", "search plugins", or needs help discovering and managing CodeBuddy Code plugins from marketplaces.
version: 0.1.0
---
