...
|---|---|---|---|---|
| Young female | `Mete-Normal (2)` | `Kyoko` | `ja-JP-NanamiNeural` | `ja-JP-Neural2-B` |
| Young male | `Kensaki-Normal (46)` | `Eddy` | `ja-JP-KeitaNeural` | `ja-JP-Neural2-C` |
| Mid-age female | `Sora-Normal (16)` | `Flo` | `ja-JP-NanamiNeural` | `ja-JP-Neural2-B` |
| Mid-age male | `Kuronoe-Normal (11)` | `Reed` | `ja-JP-KeitaNeural` | `ja-JP-Neural2-D` |
