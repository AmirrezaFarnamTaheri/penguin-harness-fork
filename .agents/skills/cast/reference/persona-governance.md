...
| PII handling for persona attributes derived from real users | GDPR (EU), CCPA (US), Act on the Protection of Personal Information (APPI) (Japan APPI amendment bill, Cabinet-approved 2026-04-07; enforcement expected by 2028) | Anonymize before persona synthesis; for AI-training use cases, document statutory basis (e.g., APPI statistical-processing exemption) — see also Cloak skill |
