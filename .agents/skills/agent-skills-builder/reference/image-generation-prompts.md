...
| warm atmosphere | warm, cozy, inviting, golden tones |
...
| ethereal | ethereal, dreamy, fantasy, soft glow |
| majestic | majestic, grand, imposing, awe-inspiring |
| delicate | delicate, intricate, fine detail, subtle |

Keep this must-keep example:

**Input**:
> A stylish workspace with a coffee cup and laptop on a wooden table in soft light
